...
export const zh = {
  ...
  'color.text': '文字色',
  'color.border': '边框色',
  'color.invertHint': '自动反转文字颜色以保证对比度',
  'color.invertBadge': '反',
  'color.hint': '开启颜色旁的「反」让该表面上的文字自动使用对比色：主色控制气泡内文字，背景色控制全局文字，无需手动搭配',
  'background.title': '背景',
  ...
  'background.videoError.type': '这不是视频文件,无法作为背景',
  'background.videoError.size': '视频超过大小上限(200MB),请压缩或裁剪后再试',
  'background.videoHint': '视频自动静音循环播放;与背景图片互斥',
  'background.videoReplace': '更换视频',
  'background.videoUnsupported': '该视频编码浏览器无法播放,请转成 H.264 MP4 或 VP8/VP9 WebM 后重新上传',
  ...
  'background.urlError.size': '文件超过大小限制(200MB)',
...
export const en = {
  ...
  'color.text': 'Text',
  'color.border': 'Border',
  'color.invertHint': 'Auto-invert text to keep contrast',
  'color.invertBadge': 'Inv',
  'color.hint': 'Toggle "Inv" next to a color to auto-contrast text on that surface: accent drives the bubble text, background drives the global text — no manual pairing needed',
  ...
  'background.videoError.size': 'Video exceeds the size limit (200MB) — trim or compress it first',
  ...
  'background.videoUnsupported': 'This browser cannot play that video codec — convert it to H.264 MP4 or VP8/VP9 WebM and upload again',
  ...
  'background.urlError.size': 'File exceeds the size limit (200MB)',
