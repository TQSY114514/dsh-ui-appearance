...
export const zh = {
  ...
  'surface.glass': '毛玻璃强度',
  'surface.hint': '背景图会显示在主区域;调低面板不透明度可让卡片、侧边栏也透出;输入框/代码块不透明度为 100% 时跟随面板不透明度',
  'scheme.title': '配色方案',
  'scheme.export': '导出配色',
  'scheme.import': '导入配色',
...
export const en = {
  ...
  'surface.hint': 'The wallpaper shows in the main area; lower panel opacity to reveal cards and the sidebar. Input/code-block opacity at 100% follows the panel opacity',
