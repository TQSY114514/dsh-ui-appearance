...
export const zh = {
  ...
  'background.weSync': '使用当前 Wallpaper Engine 壁纸',
  'background.weSyncing': '正在同步当前壁纸…',
  'background.weSynced': '已同步当前壁纸',
  'background.weBrowse': '浏览 WE 壁纸库',
  'background.weNotFound': '未检测到运行中的 Wallpaper Engine 或未找到安装路径',
  'background.weNoActive': 'Wallpaper Engine 当前未激活任何壁纸',
  'background.weBrowseTitle': 'Wallpaper Engine 本地壁纸库',
  'background.weApply': '应用',
  'background.weLoading': '正在扫描壁纸库…',
  'background.weEmpty': '未发现本地已安装的 Wallpaper Engine 壁纸',
  'background.weClose': '关闭',
  'background.weSearchPlaceholder': '搜索壁纸名称或 ID…',
  'background.weFilterAll': '全部',
  'background.weFilterWorkshop': '创意工坊',
  'background.weFilterDefault': '内置',
  'background.weVersionBadge': '{n}版',
  'background.weSwitchVersion': '切换版本',
  'background.weVersionMain': '主版本',
  ...
  'surface.glass': '毛玻璃强度',
  'surface.hint': '背景图会显示在主区域;调低面板不透明度可让卡片、侧边栏也透出;输入框/代码块不透明度独立于面板(100% = 不透明)',
...
export const en = {
  ...
  'background.weSync': 'Use current Wallpaper Engine wallpaper',
  'background.weSyncing': 'Syncing current wallpaper…',
  'background.weSynced': 'Synced current wallpaper',
  'background.weBrowse': 'Browse WE library',
  'background.weNotFound': 'Wallpaper Engine not detected or not running',
  'background.weNoActive': 'No active wallpaper in Wallpaper Engine',
  'background.weBrowseTitle': 'Wallpaper Engine Local Library',
  'background.weApply': 'Apply',
  'background.weLoading': 'Scanning wallpaper library…',
  'background.weEmpty': 'No installed Wallpaper Engine wallpapers found',
  'background.weClose': 'Close',
  'background.weSearchPlaceholder': 'Search by name or ID…',
  'background.weFilterAll': 'All',
  'background.weFilterWorkshop': 'Workshop',
  'background.weFilterDefault': 'Built-in',
  'background.weVersionBadge': '{n} ver',
  'background.weSwitchVersion': 'Switch version',
  'background.weVersionMain': 'Main',
  ...
  'surface.hint': 'The wallpaper shows in the main area; lower panel opacity to reveal cards and the sidebar. Input/code-block opacity is independent of the panel (100% = opaque)',
